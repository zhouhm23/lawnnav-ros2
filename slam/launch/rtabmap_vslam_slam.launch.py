#!/usr/bin/env python3
"""
rtabmap_vslam_slam.launch.py — (c) 视觉+雷达 RTAB-VSLAM 建图（恢复出厂）
...
TF 树:
  ...
  提供者:
    map→odom:      RTAB-Map (visual + laser ICP)
...
def launch_setup(context):
    ...
    rtabmap_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(slam_package_path, 'launch/include/rtabmap_vslam.launch.py')),
        launch_arguments={
